...
class ImageCleanModel(BaseModel):
    ...
    def init_training_settings(self):
        ...
        if train_opt.get('fft_opt'):
            ...
            cri_fft_cls = getattr(loss_module, fft_type)  #根据pop出来的loss_type找到对应的loss函数
        ...
        #         self.device)     
        # else:
        #     raise ValueError('perceptual loss are None.')
    ...
    def optimize_parameters(self, current_iter):
        ...
        with autocast(enabled=self.use_amp):
            ...
            l_pix = 0.
            for pred in preds:
                l_pix +=  self.cri_pix(pred, self.gt) + self.cri_fft(pred, self.gt)
